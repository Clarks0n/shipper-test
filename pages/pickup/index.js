...
export const getServerSideProps = wrapper.getServerSideProps(
  (store) =>
    async ({ params }) => {
      ...
      await store.dispatch(getDriverList());

      console.log("State on server", store.getState());
      const dataSource = store.getState().driverListSlice.dataSource;
      const isSuccess = store.getState().driverListSlice.isSuccess;
...
// With ServerSide Rendering
const Pickup = ({dataSource, isSuccess}) => {
